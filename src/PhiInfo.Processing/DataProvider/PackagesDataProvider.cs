...
/// 
/// </summary>
/// <param name="cldbStream">Class database (classData.tpk) file.</param>
/// <param name="zips">Apk, main obb and auxiliary (patch) obb files. Obb files are optional if the apk is
/// from TapTap since TapTap pack everything in a single apk. Packages don't have to be ordered.
/// </param>
public class PackagesDataProvider(Stream cldbStream, params ShuaZip[] zips) : IDataProvider
{
